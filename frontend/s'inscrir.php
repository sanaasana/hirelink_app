...
<head>
 ...
 <body>
  ...
  <div class="container">  
    ...
    <a class="nav-link" href="inscricondidat.php"> <button type="button" href="inscricondidat.php"  id="button" class="btn btn-dark btn-lg btn1" style="color : rgb(245, 245, 245);  font-family: Georgia, serif;padding: 15px; border-radius: 30px; margin-left: 17px; width: 300px;"><strong>Candidat </strong></button></a>
